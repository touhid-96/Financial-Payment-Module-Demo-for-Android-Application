...
public class NagadPaymentActivity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        reportDialog.setContentView(R.layout.layout_nagad_report_dialog);
        sourceAccNo_TV = (TextView) reportDialog.findViewById(R.id.src_acc_no_nagad);
        amount_TV = (TextView) reportDialog.findViewById(R.id.amount_nagad);
        dateTime_TV = (TextView) reportDialog.findViewById(R.id.date_time_nagad);
        narration_TV = (TextView) reportDialog.findViewById(R.id.narration_nagad);
        bkashNo_TV = (TextView) reportDialog.findViewById(R.id.nagad_no);
        name_TV = (TextView) reportDialog.findViewById(R.id.name_nagad);
        address_TV = (TextView) reportDialog.findViewById(R.id.address_nagad);
        downloadReceipt = (Button) reportDialog.findViewById(R.id.download_nagad);
        shareReceipt = (Button) reportDialog.findViewById(R.id.share_nagad);
        closeButton = (ImageView) reportDialog.findViewById(R.id.dialog_close_nagad);
        ...
        number_ET = (EditText) findViewById(R.id.nagad_number);
        name_ET = (EditText) findViewById(R.id.nagad_name);
        amount_ET = (EditText) findViewById(R.id.nagad_amount);
        narration_ET = (EditText) findViewById(R.id.nagad_narration);
        Button submitBtn = (Button) findViewById(R.id.nagad_submit_button);
    ...
    private void getCurrentLocation() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            fusedLocationProviderClient.getLastLocation().addOnSuccessListener(location -> {
                if (location != null) {
                    Geocoder geocoder = new Geocoder(NagadPaymentActivity.this, Locale.getDefault());
    ...
    private void FormData(String Address) {
        ...
        if (Number.isEmpty()) {
            String message = "Nagad Number Missing!";
            makeToast(message);
    ...
    private void askPermission() {
        ActivityCompat.requestPermissions(NagadPaymentActivity.this, new String[]{
